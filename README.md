git https://github.com/illicchpv/glo-anime-js
...
## Урок 4. Добавим динамики на страницы
Выведем аниме по категориям. Выведем самые популярные тайтлы. На основе полученных данных отрисуем страницу жанра аниме. Динамически отобразим информацию на странице конкретного аниме сериала.
